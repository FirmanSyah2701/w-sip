                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            @if($errors->any())
                                ...
                                @endif
                            <form action="{{url('AksiUbahPoli'.$datas->id_poli) }}" method="post" class="form-horizontal">
                                {{csrf_field()}}
                                {{method_field('PUT')}}
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="nama_poli" name="nama_poli" 
                                            class="form-control" value="{{ $datas->nama_poli }}">
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <a href="{{url ('admin/poli')}}" class="btn btn-danger btn-sm">
