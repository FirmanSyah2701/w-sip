                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Lihat</strong> Data Antrian
                            </div>
                            ...
                            <div class="card-body card-block">
                                ...
                                @endif
                                <form action="{{url('AksiUbahDataAntrian'.$datas->id_antrian) }}" 
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="date" id="tanggal_antrian" name="tanggal_antrian" 
                                                class="form-control" value="{{ $datas->tanggal_antrian }}" ReadOnly>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="no_antrian" name="no_antrian" class="form-control"
                                                placeholder="Masukan No antrian" value="{{$datas->no_antrian}}" ReadOnly>
                                        </div>
                                    </div>
