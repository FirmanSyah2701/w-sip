                ...
                <li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" 
                            aria-expanded="false"> <i class="menu-icon fa fa-table"></i>Tabel Data Akun</a>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            ...
                            @endif
                            <form action="{{url('AksiUbahDataAntrian'.$datas->id_antrian) }}" method="post" 
                                class="form-horizontal">
                                {{csrf_field()}}
                                {{method_field('PUT')}}
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="text-input" class="form-control-label">Poli dan Dokter</label>
                                    </div>
                                    <div class="col-12 col-md-9">
                                        <input type="text" class="form-control" 
                                            value="{{$datas->poli->nama_poli}} - {{ $datas->dokter->nama_dokter }}" ReadOnly>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text"  
                                            class="form-control" value="{{$datas->nama_pasien}}" ReadOnly>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text"  
                                            class="form-control" value="{{$datas->jk}}" ReadOnly>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text"  
                                            class="form-control" value="{{$datas->umur}}" ReadOnly>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="text-input" class="form-control-label">No_Hp</label>
                                    </div>
                                    <div class="col-12 col-md-9">
                                        <input type="text" class="form-control" 
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="date" id="tanggal" name="tanggal" 
                                            class="form-control" value="{{ $datas->tanggal }}" ReadOnly>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="no_antri" name="no_antrian" class="form-control"
                                            placeholder="Masukan No antrian" value="{{$datas->no_antrian}}">
                                    </div>
                                </div>
                                <div class="card-body">
