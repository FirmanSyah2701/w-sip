...
<html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="{{ url('assets/z/admin/css/lib/datatable/buttons.dataTables.min.css') }}">
            ...
            <nav class="navbar navbar-expand-sm navbar-default">
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown"  class="active">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-data__tool-right">
                                <a href="{{url ('admin/TambahDataAdmin')}}" class="btn btn-info">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($datas as $tampil)
                                                <tr>
                                                    ...
                                                    <td>  
                                                        <a href="{{ url ('admin/UbahDataAdmin', $tampil->id_admin) }}" 
                                                            class="btn btn-warning btn-sm"  title="Edit">
                                                            <i class="fas fa-pencil-alt"></i>
                                                        </a> 
                                                        <a href="{{ url ('HapusDataAdmin', $tampil->id_admin) }}" 
