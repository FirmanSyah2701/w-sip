                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong>Edit</strong> Data Rekam Medis
                        </div>
                        <div class="card-body card-block">
                            ...
                            <form action="{{url('AksiUbahRekamMedis'.$datas->id_rekam_medis) }}" method="post" 
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select name="nama_poli" id="select" class="form-control">
                                            <option value="{{$datas->id_dokter}}">
                                                {{$datas->poli->nama_poli}} - {{ $datas->dokter->nama_dokter }}
                                            </option>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select name="id_pasien" id="select" class="form-control">
                                            <option value="{{$datas->pasien->id_pasien}}">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <textarea type="text" id="keterangan" name="keterangan" class="form-control" 
                                            value="{{$datas->keterangan}}">{{$datas->keterangan}}</textarea>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <a href="{{url ('admin/rekamMedis')}}" class="btn btn-danger btn-sm">
