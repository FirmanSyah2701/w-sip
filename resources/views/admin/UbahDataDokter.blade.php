                        ...
                        <div class="card-body card-block">
                            ...
                            <form action="{{url('AksiUbahDataDokter', $datas->id_dokter) }}" method="post" 
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="nama_dokter" name="nama_dokter" 
                                            class="form-control" value="{{$datas->nama_dokter}}">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select name="id_poli" id="select" class="form-control">
                                            <option value="{{$datas->poli->id_poli}}">
                                    ...
                                    <div class="col col-md-9">
                                        <div class="form-check-inline form-check">
                                            <label for="inline-radio1" class="form-check-label ">
                                                <input type="radio" id="kl" name="jk" value="perempuan" 
                                                    class="form-check-input" {{$datas->jenis_kelamin == 'perempuan'? 'checked' : ''}}>Perempuan
                                            </label>
                                        </div>
                                        <div class=" form-check">
                                            <label for="inline-radio2" class="form-check-label ">
                                                <input type="radio" id="jenis_kelamin" name="jk" value="laki-laki" 
                                                    class="form-check-input" {{$datas->jk == 'laki-laki'? 'checked' : ''}}>Laki-Laki
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="no_hp" name="no_telp" class="form-control" value="{{$datas->no_telp}}">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <textarea type="text" id="alamat" name="alamat" 
                                            class="form-control" >{{$datas->alamat}}</textarea>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
