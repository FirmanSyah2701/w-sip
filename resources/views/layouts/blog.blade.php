                    ...
                    <div class="single-home-blog">
                        <div class="card mt-5">
                            ...
                            <div class="card-body">
                                ...
                                <ul>
                                    <li> <span class="ti-calendar"></span>{{ \Carbon\Carbon::parse($blog->tanggal)->translatedFormat('l,d F Y') }}</li><br>
                                    <center>
                                        <li> <span ><a href="{{ url('/detail_blog/'.$blog->slug)}}" style="color : blue">Selengkapnya...</a></span></li>
                                    </center>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="footer section_padding">
            <div class="container">
                <div class="row justify-content-between">
                    ...
                    <a href="{{ url('/') }}" class="footer_logo"> <img src="{{ url('assets/z/img/logopus.png') }}" alt="#"> </a>
